...
const DONATION_DESTINATION_WALLET =
  'EWTc5Sv18tJmvYXrRjdPZJcrhMjZ2qfHQeKtwaJE3NsH';
const DONATION_AMOUNT_SOL_OPTIONS = [0.01, 0.1, 1];
...
> {
  const icon =
    'https://ipfs.io/ipfs/QmextKASCXQo5VC3Vnb18C8KpAgHDPfmvDEJnAZeHw3Bp8';
  const title = "Donate to Stefans, Don't Blink!";
  const description =
